...
public:
    ...
    bool isLinked(ListNode<GraphNode<T> *> &node1, ListNode<GraphNode<T> *> &node2)
    {
        GraphNode<T> *graphNode1 = node1.getData();
        GraphNode<T> *graphNode2 = node2.getData();

        if (graphNode1 != NULL && graphNode2 != NULL)
        {
            return isLinked(graphNode1, graphNode2);
        }
    ...
    void BFS(GraphNode<T> *node)
    {
        ...
        while (!l->isEmpty())
        {
            ListNode<GraphNode<T> *> *cur = l->removeFromHead();
            cout << cur->getData()->getData() << " ";

            ListNode<GraphNode<T> *> *e = (*(cur->getData()))[0];
            while (e != NULL)
            {
                if (!l->exist(e->getData()))
    ...
    void DFS(GraphNode<T> *node)
    {
        ...
        while (!l->isEmpty())
        {
            ListNode<GraphNode<T> *> *cur = l->removeFromTail();
            cout << cur->getData()->getData() << " ";
